...
// Reuse DepartmentList from Principal logic, as VP likely has similar access
    ...
    return (
        <div className="full-width-container">
            <div className="full-width-header">
                <h4 style={{ margin: 0 }}>Departments & HODs (Vice Principal Access)</h4>
            </div>
        ...
        <div className="dashboard-layout">
            <header className="top-navbar">
                <div className="nav-brand" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span className="badge-role">Vice Principal Portal</span>
                </div>
                ...
                <div className="nav-profile">
                    <span className="user-name">Dr. Vice Principal</span>
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', animation: 'fadeIn 0.5s' }}>
            <div className="dashboard-header">
                <div>
                    <h2 className="title-gradient">Welcome back, Vice Principal 👋</h2>
