...
function VicePrincipalDashboard() {
    ...
    const renderContent = () => {
        ...
        let currentUser = { name: 'Vice Principal', role: 'vice_principal' };
        try { if (userStr && userStr !== "undefined") {
            const parsed = JSON.parse(userStr);
            if (parsed.role === 'vice_principal') currentUser = parsed;
            ...
            <aside className={`glass-sidebar ${mobileMenuOpen ? 'open' : ''}`}>
                <div className="sidebar-header">
                    ...
                    <div>
                        ...
                        <div className="sidebar-role">Vice Principal Portal</div>
                    </div>
                </div>
